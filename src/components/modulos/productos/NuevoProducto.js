...
class NuevoEmpleado extends Component {
    ...
    componentWillMount(){
        ...
        axios.get('http://localhost:1337/Rol/rols', {headers: {'access-token': accessToken}})
            .then(res => {
                        ...
                        <div align="center">
                            <form onSubmit={this.crearEmpleado} className="col-8">
                                <div className="form-group">
                                    <label>DNI</label>
                                    <input ref={this.dniRef} type="text" className="form-control"/>
                                </div>
                                <div className="form-group">
                                    <label>Nombre</label>
                                ...
                                <div className="form-group">
                                    ...
                                    <input ref={this.primerTelefonoRef} type="text" className="form-control" />
                                </div>
                                <div className="form-group">
                                    <label>2º Telefono / Celular</label>
                                    <input ref={this.segundoTelefonoRef} type="text" className="form-control" />
                                </div>
                                <div className="form-group">
                                    <label>Rol</label>
